  ...
  return (
    <div className="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center mt-[8rem]">
      <h1 className="text-5xl font-extrabold leading-10 tracking-tight text-left text-gray-900 md:text-center sm:leading-none md:text-6xl lg:text-7xl">
        ...
        <span className="relative h-[10rem] mt-2 text-transparent bg-clip-text bg-gradient-to-br from-[#FFE3E1] to-[#ff0000] md:inline-block">creator economy re-imagined</span>
      </h1>
